...
class RegistrationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val studentPassword = intent.getStringExtra("STUDENT_PASSWORD") ?: ""
        ...
        val savedCourses = sharedPrefs.getStringSet(userSpecificKey, setOf()) ?: setOf()
        selectedCourses.addAll(savedCourses)

        allCourses = listOf(
            "CSE 101 - Introduction to Programming", "CSE 202 - Data Structures",
            "MAT 111 - Calculus I", "PHY 101 - Physics I", "ENG 101 - English Composition",
            "CSE 102 - Object-Oriented Programming", "CSE 303 - Database Systems",
            "CSE 404 - Computer Networks", "CSE 505 - Software Engineering",
            "CSE 606 - Artificial Intelligence", "CSE 707 - Computer Graphics",
            "CSE 808 - Operating Systems", "CSE 909 - Computer Architecture",
            "CSE 100 - Web Programming", "CSE 201 - Discrete Mathematics",
            "CSE 302 - Computer Organization", "CSE 403 - Computer Networks Lab",
            "CSE 504 - Software Engineering Lab", "CSE 605 - Artificial Intelligence Lab",
        ...
        btnOk.setOnClickListener {
            ...
            sharedPrefs.edit().putStringSet(userSpecificKey, selectedCourses).apply()
